      ...
      <div className="w-full max-w-xl mx-auto">
        ...
        <div className="rounded-3xl bg-white shadow-2xl overflow-hidden">
          ...
          <div className="bg-[#1a4d35] px-8 pt-10 pb-8 text-center">
            ...
            <p className="font-serif text-2xl md:text-3xl font-semibold text-amber-400 text-left mt-3">
              Dear {firstName},
            </p>
          </div>
          ...
          <div className="px-8 py-8">
            {/* Note */}
            <div className="text-sm text-muted-foreground leading-[1.85] mb-8 space-y-4 text-justify">
              {isLecturer ? (
                <>
                  <p>Welcome to Tolumor. For years, your knowledge lived inside four walls, shared with whoever was lucky enough to sit in your class. Not anymore. Here, your teaching outlives the semester, and your reach outgrows the classroom. Every lesson you upload becomes a lifeline for a student you may never meet, in a school you may never visit. This is bigger than content, it's your legacy, multiplied. Let's build it together.</p>
                </>
              ) : (
                <>
                  <p>Every great lawyer once sat where you're sitting now, unsure, a little afraid, wondering if they truly belonged in this. That feeling doesn't disappoint, it means you're standing at the beginning of something worth doing.</p>
                  <p>Law was never meant to be learned alone in the dark, it was meant to be taught, passed from one hand to the next, one mind lighting another. That's why Tolumor exists. Somewhere out there, a courtroom is waiting for you, a client is waiting for you, a life is waiting for you to learn well enough to change it. So open the first lesson, ask the hard questions, fail the quiz if you must, then rise and pass it. This is not just a course, it's the start of the lawyer you're becoming.</p>
                  <p>Welcome, let's get to work.</p>
                </>
              )}
            </div>

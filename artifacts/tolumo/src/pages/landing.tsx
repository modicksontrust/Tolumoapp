        ...
        <section className="py-20 md:py-28 bg-[#F5F2EB]">
          <div className="container mx-auto px-4 md:px-6 max-w-6xl">
            ...
            <div className="grid sm:grid-cols-3 gap-5">
              {[
                {
                  quote: '"I\'d failed Constitutional Law twice before Tolumor. The way Prof. Adeyemi breaks down the Second Schedule finally made it click. I passed with a B+ this time."',
                  name: 'Chisom Anieke',
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start">
              ...
              <div>
                ...
                <div className="space-y-5 text-sm text-muted-foreground leading-relaxed">
                  <p>
                    Tolumor was born from a simple observation: Nigerian law students are among the hardest-working students in the world, yet thousands fail preventable exams every year — not from lack of effort, but from lack of access to quality teaching resources.
                  </p>
                  <p>
            ...
            <div className="grid md:grid-cols-[280px_1fr] gap-12 items-start">
              ...
              <div className="md:sticky md:top-24 space-y-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Founder, Tolumor.</p>
                </div>
                {/* Pull quote */}
                <blockquote className="border-l-4 border-accent pl-4 text-sm text-muted-foreground italic leading-relaxed">
                  "Tolumor is the classroom I wish every student could have had: a place where complex ideas become crystal clear, where fear loosens its grip, and where every learner is reminded they are not a mistake, not an afterthought, and never too late."
                </blockquote>
              </div>
              ...
              <div className="prose prose-sm prose-primary max-w-none text-muted-foreground leading-relaxed space-y-5 text-sm">
                ...
                <p>Some lecturers lit lamps inside us. Others did their best to convince us that the light was not ours to carry. But we made a quiet promise: where we started would not write the final sentence of our story.</p>
                ...
                <div className="rounded-xl bg-primary px-8 py-6 not-prose my-8">
                  ...
                  <p className="text-sm text-white/60 italic">That question became Tolumor.</p>
                </div>

                <p>In my native Ijaw language, <strong className="text-primary">Tolumor</strong> means "to teach." But to me, it is much more than a word; it is a promise. Tolumor is the classroom I wish every student could have had: a place where complex ideas become crystal clear, where fear loosens its grip, and where every learner is reminded that they are not a mistake, not an afterthought, and never "too late" or "too little." You are exactly who you need to be to begin.</p>
                <p>Tolumor is not just a platform. It is a movement of second chances, of "try again," and of "you are closer than you think." It is built on the unwavering belief that while talent is everywhere, opportunity is not — and we are here to change that.</p>
                ...
                <p><strong className="text-primary">Welcome to Tolumor!<br />I am honored to walk this road with you.</strong></p>
